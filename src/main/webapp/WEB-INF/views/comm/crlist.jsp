...
<script type="text/javascript">
    $(function () {
        ...
        $('.reply').click(function () {
            ...
            if ($replyForm.length === 0) {
                ...
                formHtml += '<button class="btn btn-primary" onclick="commReplyInsert(' + reId + ')">등록</button>';
	...
	function openReReportPopup(reId) {
		window.open('commReReport?re_id=' + reId, '신고하기', 'width=450,height=500');
	}
</script>
</head>
<body>
