					...
					<div class="card-body">
						<form method=post action="commupdate">
							...
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" id="title" name="title" value="${comm.title}">
								</div>
							</div>
							<div class="row mb-3">
								<label for="content" class="col-sm-2 col-form-label">내용</label>
								<div class="col-sm-10">
									<textarea class="form-control" style="height: 300px" id="content" name="content">${comm.content}</textarea>
								</div>
							</div>
							<div class="row mb-3">
								<div class="col-sm-2">
								...
								<div class="col-sm-2">
									<button type="button" class="btn btn btn-outline-primary" style="width: 100%" onclick="location.href='commlist'">목록</button>
								</div>
							</div>
						</form>
					</div>
