...
<aside id="sidebar" class="sidebar">
	<ul class="sidebar-nav" id="sidebar-nav">
		...
		<li class="nav-item"><a class="nav-link collapsed" href="#">
				<i class="bi bi-bag-check"></i> <span>쇼핑후기</span>
		</a></li>
		<li class="nav-item"><a class="nav-link collapsed" href="#">
				<i class="bi bi-chat-left-text"></i> <span>커뮤니티</span>
		</a></li>
		<li class="nav-heading">Personal</li>
		<li class="nav-item"><a class="nav-link collapsed"
			href="users-profile.html"> <i class="bi bi-person"></i> <span>회원정보</span>
		</a></li>
		<!-- End Profile Page Nav -->
		<li class="nav-item"><a class="nav-link collapsed"
			data-bs-target="#charts-nav" data-bs-toggle="collapse" href="#">
				<i class="bi bi-pencil-square"></i><span>활동 내역</span><i
				class="bi bi-chevron-down ms-auto"></i>
		</a>
			<ul id="charts-nav" class="nav-content collapse "
				data-bs-parent="#sidebar-nav">
				<li><a href="charts-chartjs.html"> <i class="bi bi-circle"></i><span>글</span>
				</a></li>
				<li><a href="charts-apexcharts.html"> <i
						class="bi bi-circle"></i><span>댓글</span>
				</a></li>
				<li><a href="charts-echarts.html"> <i class="bi bi-circle"></i><span>좋아요</span>
				</a></li>
				<li><a href="charts-echarts.html"> <i class="bi bi-circle"></i><span>스크랩</span>
				</a></li>
			</ul></li>
		<!-- End Charts Nav -->
		<li class="nav-item"><a class="nav-link collapsed"
			data-bs-target="#qnaCarts-nav" data-bs-toggle="collapse" href="#">
				<i class="bi bi-question-circle"></i><span>문의하기</span><i
				class="bi bi-chevron-down ms-auto"></i>
		</a>
			<ul id="qnaCarts-nav" class="nav-content collapse "
				data-bs-parent="#sidebar-nav">
				<li><a href="charts-chartjs.html"> <i class="bi bi-circle"></i><span>문의
							이메일: example@example.com</span>
				</a></li>
			</ul></li>
		<!-- End Charts Nav -->
		<li class="nav-item"><a class="nav-link collapsed"
			href="pages-faq.html"> <i class="bi bi-person-dash"></i> <span>회원탈퇴</span>
		</a></li>
	</ul>
</aside>
<!-- End Sidebar-->
