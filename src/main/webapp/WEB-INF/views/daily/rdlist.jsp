...
<script type="text/javascript">
	$(function() {
		$('.edit1').click(function() { // 클래스값이 edit1으로 되어있는 값을 구해와라(수정버튼)
			var id  = $(this).attr('id');  // rno(this는 여러개수정버튼 중에 사용자가 선택한 수정버튼, id변수에 저장)
	...
	function up(id) {	// 댓글 내용 수정
		...
		var formData = "post_id="+id+'&re_content='+re_content
	...
	function lst() {
		$('#rdlist').load('${path}/rdlist/post)id/${daily.post_id}
	}
