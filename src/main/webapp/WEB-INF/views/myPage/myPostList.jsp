...
<main id="main" class="main">
	...
	<div class="pagetitle" style="margin-bottom: 30px">
		...
		<nav>
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="index.html">작성 글</a></li>
			</ol>
		</nav>
	</div><!-- End Page Title -->
			...
			<c:if test="${not empty postList}">
				...
				<c:forEach var="post" items="${postList}">
					<tr>
						...
						<td><a href="detail?type_name=${post.board_type}&post_id=${post.post_id}">${post.title}</a></td>
						<td>${post.nick}</td>
						<td>
				...
				<div style="display: flex; justify-content: center;">
					<ul class="pagination">
						...
						<c:if test="${startPage > 10}">
							<li class="page-item">
								<a class="page-link" href="myPostList?page=${startPage - 10}" tabindex="-1">&laquo;</a>
							</li>
						</c:if>
						<!-- 각 블럭에 10개의 페이지 출력 -->
