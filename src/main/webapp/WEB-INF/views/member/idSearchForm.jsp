					...
					<div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
						<div class="card mb-3">
							<div class="card-body">
								...
								<div class="pt-4 pb-2">
									<h5 class="card-title text-center pb-0 fs-4">Search ID</h5>
									<p class="text-center small">Enter your phone number with "-"</p>
								</div>
								<form class="row g-3 needs-validation" action="idSearch" novalidate>
									<div class="col-12">
								...
								<c:if test="${!empty searchId }">
									...
									<div class="col-12">
										<label for="yourUsername" class="form-label">ID Result</label>
										<div class="input-group has-validation">
